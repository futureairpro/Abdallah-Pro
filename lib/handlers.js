...
export function registerHandlers(bot) {
  ...
  bot.use(async (ctx, next) => {
    ...
    if (!profile.is_active) {
      ...
      paywallMsg += `━━━━━━━━━━━━━━━━━━━━━\n`;
      paywallMsg += `للاشتراك وتجديد حسابك ومتابعة المذاكرة واستخدام المنظومة:\n\n`;
      paywallMsg += `💳 <b>رسوم الاشتراك الشهري:</b> 30 ج.م فقط شهرياً\n\n`;
      paywallMsg += `📞 <b>للتواصل والاشتراك أو حل أي مشكلة:</b>\n`;
  ...
  // ==============================================================================
  bot.command(['support', 'contact', 'help_support', 'subscribe', 'help'], async (ctx) => {
    let supportMsg = `💬 <b>خدمة العملاء والدعم الفني والاشتراكات:</b>\n`;
    supportMsg += `━━━━━━━━━━━━━━━━━━━━━\n`;
    supportMsg += `أهلاً بك يا دكتور! يسعدنا مساعدتك والرد على كافة استفساراتك فوراً:\n\n`;
    supportMsg += `✈️ <b>تليجرام (مباشر):</b> <a href="https://t.me/Dr31327">@Dr31327</a>\n`;
    supportMsg += `🟢 <b>واتساب (WhatsApp):</b> <a href="https://wa.me/201096247662">+201096247662</a>\n\n`;
    supportMsg += `💳 <b>قيمة الاشتراك الشهري:</b> 30 ج.م فقط.\n`;
    supportMsg += `👇 <i>يمكنك الضغط على الأزرار أدناه للتواصل المباشر:</i>`;
