...
export function registerHandlers(bot) {
  ...
  bot.use(async (ctx, next) => {
    ...
    if (!profile) {
      ...
      promptMsg += `⚠️ <b>خطوة تفعيل حسابك والبدء:</b>\n`;

      promptMsg += `لتسجيل حسابك وبدء فترتك التجريبية (3 أيام)، يرجى كتابة اسمك مسبوقاً بـ <b>(أنا اسمي)</b> أو <b>(د.)</b> في رسالة، مثل:\n\n`;
      ...
      promptMsg += `✍️ <i>اكتب اسمك الآن بالطريقة الموضحة أعلاه للبدء فوراً! 👇</i>`;
