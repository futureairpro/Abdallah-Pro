...
المستخدم هو "${studentName}" - طالب طب بشري في ${year} (${semester}).
...
6. 💵 المالية (finance):
   ...
   - طريقة الدفع payment_method: إذا لم يذكر طريقة الدفع صراحة أو قال كاش/فلوس، اجعلها دائماً "نقدي (كاش)". إذا ذكر فودافون كاش أو اتصالات كاش أو أورانج كاش أو وي باي أو أي محفظة ذكية/إلكترونية، اجعلها "محفظة إلكترونية". إذا ذكر إنستا باي (InstaPay) أو تحويل بنكي، اجعلها "إنستا باي".
