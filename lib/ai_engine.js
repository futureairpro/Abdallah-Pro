...
قواعد تحويل واستخراج الأرقام والمدد الزمنية والموديولات بدقة شديدة:
1. 📚 المذاكرة (study):
   ...
   - تمييز كود الموديول الطبي تلقائياً:
     ...
     * أطفال / بيديكس ➔ PED401
     * صدرية / تنفسي ➔ RSD403
     * أوعية دموية / فاسكولار ➔ HVD404
     * مهارات إكلينيكية / سكيلز ➔ SKL 7
   - استخراج عدد الصفحات في pages_covered إن ذكرت.

2. 📝 صياغة summary_text:
   - يجب أن يذكر summary_text تفاصيل ما تم فهمه بوضوح تام (مثال: "تم توثيق جلسة مذاكرة موديول الكارديو (CAD402) لموضوع كذا لمدة 4 ساعات (240 دقيقة)..."). اذكر الأرقام والمدد والمبالغ والأسماء بدقة ليعرف د. عبدالله فوراً ما تم فهمه.

3. 🏋️‍♂️ الجيم (fitness_gym):
   - حول وقت التمرين إلى دقائق في duration_minutes، واستخرج العضلات المستهدفة وجرامات البروتين وكمية الماء.

4. 💵 المالية (finance):
   - استخرج المبلغ في amount كـ Number، والنوع (مصروف / إيراد)، وطريقة الدفع (خزنة شخصية / فودافون كاش / إنستا باي / بنك مصر).

5. 📖 القرآن (quran):
   - استخرج اسم السورة، عدد الصفحات في pages_count، ونوع الجلسة (حفظ جديد / مراجعة تثبيت).

6. 💤 النوم والصلاة (prayer_habits):
   - استخرج عدد ساعات النوم الفعلي في sleep_hours، ووقت الاستيقاظ والنوم، وحالة الصلوات الخمس.

هيكل الـ JSON المطلوب بدقة:
{
  "summary_text": "ملخص مفصل وواضح يذكر المدة الدقيقة والموضوع والموديول والمبالغ باللغة العربية مع إيموجي راقية",
  "data": {
    "date": null,
    "english_flashcards": [],
    "medical_quizzes": [],
