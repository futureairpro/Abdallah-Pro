...
Task: The student (${studentName}) is having an English speaking / conversational session.
Break down the English conversation transcript sentence-by-sentence into FULL, complete spoken sentences WITH their natural transitions, connectors, and discourse markers (e.g. "Because the echo thing...", "Let's focus on...", "Of course...", "As for the issue of...", "So this is...", "Every time I try to...", "I mean, for example...", "But of course...").
...
Also extract key idioms, connectors, and technical/psychological terms (like "sympathetic overreaction", "amygdala", "on alert", "echo thing", "bad influence", "potential") as separate cards.
...
{
  "detected_type": "medical_quiz" أو "english_flashcard" أو "medical_note" أو "academic_schedule",
