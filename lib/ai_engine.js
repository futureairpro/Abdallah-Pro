...
8. 🕌 الصلاة والنوم والعبادات (prayer_habits):
   - استخرج عدد ساعات النوم الفعلي في sleep_hours، ووقت الاستيقاظ والنوم.
   - إذا ذكر أنه صلى أي صلاة من الصلوات الخمس (مثل "صليت الفجر", "أديت الفجر", "صليت الظهر", "صليت العصر", "صليت المغرب", "صليت العشاء", "صليت في المسجد"):
     * ضع فوراً في prayer_habits اسم الصلاة المعنية (fajr, dhuhr, asr, maghrib, isha) بالقيمة "حاضر في المسجد 🟢" أو "حاضر".
     * وإذا ذكر سنن أو ركعات ضعها في sunan_rawatib.
     * وإذا ذكر أذكار الصباح أو المساء ضعها في adhkar_morning / adhkar_evening.

11. 🧭 طلب توجيه أو خطة أو ماذا أفعل الآن (what_to_do_now):
    - إذا قال ${studentName} "أعمل إيه دلوقتي؟", "أنا تايه", "مش عارف أبدأ بإيه", "مش عارف أذاكر إيه", "قولي أعمل إيه", "خطة النهاردة", "what should i do":
      * اجعل detected_type = "what_to_do_now" وضع is_what_to_do_now = true في الـ data.
