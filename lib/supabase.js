...
const supabaseUrl = process.env.SUPABASE_URL || 'https://rkpkjilrsylgoomqxouq.supabase.co';
const supabaseKey = process.env.SUPABASE_SERVICE_ROLE_KEY || process.env.SUPABASE_ANON_KEY || 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InJrcGtqaWxyc3lsZ29vbXF4b3VxIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc4ODQ5MDc4MCwiZXhwIjoyMTA0MDY2NzgwfQ.JRYzMZS400S456v3dbmZ5sxp-87DzIa-_gPyq7r6zzk';
